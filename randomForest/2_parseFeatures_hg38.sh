...
B=./features/genebody.hg38.sorted.bed
...
B=./features/simpleRepeats.hg38.sorted.bed
...
FEATURE_BED=features/genebody.hg38.sorted.bed
...
B=./features/repliseq.hg38.sorted.bed
